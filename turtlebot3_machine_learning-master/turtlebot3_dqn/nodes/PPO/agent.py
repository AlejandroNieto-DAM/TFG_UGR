...
import os
from nodes.PPO.networks import Critic, Actor
from nodes.PPO.memory import Memory
import rospy
...
class PPO:
    ...
    def train_step(self, states, old_probs, actions, advantage, vals_arr):
        ...
        for _ in range(self.n_epochs):
            ...
            for batch in batches:
                ...
                with tf.GradientTape(persistent=True) as tape:
                    ...
                    weighted_clipped_probs = clipped_probs * advantage_batch

                    actor_loss = -tf.reduce_mean(tf.minimum(weighted_probs, weighted_clipped_probs))

                    returns = advantage_batch + vals_arr_batch
